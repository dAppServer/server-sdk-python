...
class BlockchainLetheanDaemonStartDTO(BaseModel):
    """
    BlockchainLetheanDaemonStartDTO
    """ # noqa: E501
    config_file: StrictStr = Field(alias="configFile")
    data_dir: StrictStr = Field(alias="dataDir")
    log_dir: StrictStr = Field(alias="logDir")
    __properties: ClassVar[List[str]] = ["configFile", "dataDir", "logDir"]
