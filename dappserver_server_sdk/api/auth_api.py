...
class AuthApi:
    ...
    def create(
        ...
        :param create_account_dto:  (required)
        :type create_account_dto: CreateAccountDTO
        ...
        _param = self._create_serialize(
            create_account_dto=create_account_dto,
    ...
    def create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateAccountResponseDTO]:
        """create
    ...
    def _create_serialize(
        ...
        if create_account_dto is not None:
            _body_params = create_account_dto
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/auth/lethean/create',
    ...
    def delete(
        ...
        :param delete_account_dto:  (required)
        :type delete_account_dto: DeleteAccountDTO
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_serialize(
            delete_account_dto=delete_account_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _delete_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if delete_account_dto is not None:
            _body_params = delete_account_dto
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/auth/lethean/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def login(
        ...
        :param encrypted_request_dto:  (required)
        :type encrypted_request_dto: EncryptedRequestDTO
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._login_serialize(
            encrypted_request_dto=encrypted_request_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def login_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EncryptedResponseDTO]:
        """login
    ...
    def _login_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if encrypted_request_dto is not None:
            _body_params = encrypted_request_dto
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/auth/lethean/login',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
